...
<head>
    ...
    <title>Gpro - @yield('pageTitle')   </title>
    <link rel="stylesheet preload" as="style" href="frontend/css/preload.min.css" />
    <link rel="stylesheet preload" as="style" href="frontend/css/libs.min.css" />
...
<header class="header d-flex flex-wrap align-items-center" data-page="home2" data-overlay="true">
    <div class="container d-flex flex-wrap flex-xl-nowrap align-items-center justify-content-between">
        <a class="brand header_logo d-flex align-items-center" href="/">
                    <span class="logo">
            ...
            <span class="accent">Gp</span>
            <span>ro</span>
        </a>
        <nav class="header_nav">
            <ul class="header_nav-list">
                <li class="header_nav-list_item ">
                    <a class="nav-link d-inline-flex align-items-center" href="{{ url('/') }}">Home</a>
                </li>
                <li class="header_nav-list_item ">
                    <a class="nav-link d-inline-flex align-items-center" href="{{ url('/about') }}">About</a>
                </li>
                <li class="header_nav-list_item ">
                    <a class="nav-link d-inline-flex align-items-center" href="{{ url('/faq') }}">FAQ</a>
                </li>
                <li class="header_nav-list_item ">
                    <a class="nav-link d-inline-flex align-items-center" href="{{ url('/contact') }}">Contact</a>
                </li>
                <li class="header_nav-list_item ">
                    <a class="nav-link d-inline-flex align-items-center" href="{{ url('/#shop') }}">Shop</a>
                </li>
            </ul>
        </nav>
        ...
        <div class="container d-flex flex-column flex-md-row flex-wrap flex-xl-nowrap justify-content-xl-between">
            <div class="footer_main-about footer_main-block col-md-6 col-xl-auto">
                ...
                <div class="footer_main-about_wrapper">
                    <p class="text">
                        Great Provider Global Network Limited AKA Gpro  is a dully registered company, under Company and Allied Matters Act with registration number….RC:1427112
                    </p>
            ...
            <div class="footer_main-contacts footer_main-block col-md-6 col-xl-auto">
                ...
                <ul class="footer_main-contacts_list">
                    ...
                    <li class="list-item d-flex align-items-center">
                        ...
                        <div class="wrapper d-flex flex-column">
                            <span>Head office : Suite T 1 Febson Mall </span><span> Wuse Zone IV</span>
                            <span>Federal Capital Territory</span>
                ...
                <ul class="footer_main-instagram_list d-grid">
                    <li class="list-item">
                        <a class="link" href="#" target="_blank" rel="noopener norefferer">
                            <picture>
                                <source data-srcset="frontend/img/footer/01.webp"
                                        srcset="frontend/img/footer/01.webp" type="image/webp" />
                                <img
                                    class="lazy preview"
                                    data-src="frontend/img/footer/01.webp"
                                    src="frontend/img/footer/01.webp"
                                    alt="instagram post"
                                />
                            </picture>
                        </a>
                    ...
                    <li class="list-item">
                        <a class="link" href="#" target="_blank" rel="noopener norefferer">
                            <picture>
                                <source data-srcset="frontend/img/footer/02.webp"
                                        srcset="frontend/img/footer/02.webp" type="image/webp" />
                                <img
                                    class="lazy preview"
                                    data-src="frontend/img/footer/02.webp"
                                    src="frontend/img/footer/02.webp"
                                    alt="instagram post"
                                />
                            </picture>
                        </a>
                    ...
                    <li class="list-item">
                        <a class="link" href="#" target="_blank" rel="noopener norefferer">
                            <picture>
                                <source data-srcset="frontend/img/footer/03.webp"
                                        srcset="frontend/img/footer/03.webp" type="image/webp" />
                                <img
                                    class="lazy preview"
                                    data-src="frontend/img/footer/03.webp"
                                    src="frontend/img/footer/03.webp"
                                    alt="instagram post"
                                />
                            </picture>
                        </a>
                    ...
                    <li class="list-item">
                        <a class="link" href="#" target="_blank" rel="noopener norefferer">
                            <picture>
                                <source data-srcset="frontend/img/footer/04.webp"
                                        srcset="frontend/img/footer/04.webp" type="image/webp" />
                                <img
                                    class="lazy preview"
                                    data-src="frontend/img/footer/04.webp"
                                    src="frontend/img/footer/04.webp"
                                    alt="instagram post"
                                />
                            </picture>
                        </a>
                    ...
                    <li class="list-item">
                        <a class="link" href="#" target="_blank" rel="noopener norefferer">
                            <picture>
                                <source data-srcset="frontend/img/footer/05.webp"
                                        srcset="frontend/img/footer/05.webp" type="image/webp" />
                                <img
                                    class="lazy preview"
                                    data-src="frontend/img/footer/05.webp"
                                    src="frontend/img/footer/05.webp"
                                    alt="instagram post"
                                />
                            </picture>
                        </a>
                    ...
                    <li class="list-item">
                        <a class="link" href="#" target="_blank" rel="noopener norefferer">
                            <picture>
                                <source data-srcset="frontend/img/footer/06.webp"
                                        srcset="frontend/img/footer/06.webp" type="image/webp" />
                                <img
                                    class="lazy preview"
                                    data-src="frontend/img/footer/06.webp"
                                    src="frontend/img/footer/06.webp"
                                    alt="instagram post"
                                />
                            </picture>
                        </a>
...
<script src="frontend/js/common2.js"></script>
@yield('scripts')
