...
@section('styles')
    <link rel="stylesheet" type='text/css' href="{{ URL::asset('frontend/css/about.css') }}" />
@stop
            ...
            <div class="about_main d-lg-flex justify-content-between">
                <div class="about_main-content col-lg-6 col-xl-auto">
                    ...
                    <p class="about_main-content_text">
                        Great Provider Global Network Limited AKA GPro, is a dully registered company in Nigeria under Company and Allied Matters Act with registration number….RC:1427112,
                        with a mandate to fight the high level of unemployment in our society.
                        GPro is designed to get you equipped with skills,Healthy health product and information. it is new and rewarding
                    </p>
                    <p class="about_main-content_text">
                        it is simple and the first of its kind. The truth is, we believe in reality and we dont promise what is not visible,
                        or what you will work your life out without achieving the desired result. Chech out our compensation plan and you will
                        see all the unique and simple features embeded in our business.
                    </p>
                </div>
                <div class="about_main-media">
                    <picture>
                        <source data-srcset="frontend/img/about.webp" srcset="frontend/img/about.webp" type="image/webp" />
                        <img class="lazy" data-src="frontend/img/about.webp" src="frontend/img/about.webp" alt="media" />
                    </picture>
                </div>
            </div>
    ...
    <section class="features section--nopb">
        <div class="container">
            <div class="features_header">
                <h2 class="features_header-title">Company Mission/Vision</h2>
                <p class="features_header-text">
                    Our vision: To be the leading Skills Training Platform in Nigeria and one of the best in Africa and Beyond..
                    <br/>
                    Our mission is To utilize network marketing resources, materials and partners to provide access to profitable
                    skills and cash for the empowerment of Nigeria and Africa in general.
                </p>
            </div>
        ...
        <div class="container">
            <div class="sale_grid d-grid">
                <div class="sale_header">
                    <h2 class="sale_header-title">Buy the best health care Product for Sale Online</h2>
                    <p class="sale_header-text">One free samples with any order when you spend ₦90,000</p>
                    <a class="sale_header-btn btn" href="{url('/shop')}}">Shop Now</a>
                </div>
                ...
                <div class="sale_grid-item sale_grid-item--am">
                    ...
                    <div class="sale_grid-item_content d-flex flex-column justify-content-end">
                        <h3 class="sale_grid-item_title">Beauty Products </h3>
                        <div class="wrapper d-flex flex-column">
                ...
                <div class="sale_grid-item sale_grid-item--weekly">
                    <div class="sale_grid-item_bg">
                        <picture>
                            <source
                                data-srcset="frontend/img/about/sale--weekly.webp"
                                srcset="frontend/img/about/sale--weekly.webp"
                                type="image/webp"
                            />
                            <img class="lazy" data-src="frontend/img/about/sale--weekly.webp"
                                 src="frontend/img/about/sale--weekly.webp" alt="media" />
                        </picture>
                    </div>
                    <div class="sale_grid-item_content d-flex flex-column justify-content-center">
                        <span class="label d-flex align-items-center justify-content-center">-25%</span>
                        <span class="sale_grid-item_subtitle">Get 20% ROI every twenty working days</span>
                        <h3 class="sale_grid-item_title">Investment <span class="linebreak">Coming Soon </span></h3>
                        <a class="btn--underline" href="{{url('/shop')}}">Shop now</a>
                    </div>
                </div>
            </div>
