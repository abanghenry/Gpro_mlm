...
@section('content')
    ...
    <div id="page-content">
        <div id='wrap'>
            <div id="page-heading">
                <ol class="breadcrumb">
                    <li><a href="{{ url('admin/bonus/directrepurchase') }}">Bonus Direct Repurchase</a></li>
                </ol>

                <h1>Binary Direct Repurchase</h1>
                            ...
                            <div class="panel-body">
                              <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped  datatables" id="example">
                                    ...
                                    <tbody>
                                    @foreach ($bonusDirectPurchases as $bonus)
                                        <tr>
