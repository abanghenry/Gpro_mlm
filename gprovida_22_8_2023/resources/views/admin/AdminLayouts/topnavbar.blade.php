    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <div class="navbar-header pull-left">
            <a class="navbar-brand" href="index.php">GPG</a>
        </div>

        <ul class="nav navbar-nav pull-right toolbar">
        	<li class="dropdown">
        		<a href="#" class="dropdown-toggle username" data-toggle="dropdown"><span class="hidden-xs">John McCartney <i class="fa fa-caret-down"></i></span><img src="/adminTemplate/demo/avatar/dangerfield.png" alt="Dangerfield" /></a>
        		<ul class="dropdown-menu userinfo arrow">
        			<li class="username">
                        <a href="#">
        				    <div class="pull-left"><img src="/adminTemplate/demo/avatar/dangerfield.png" alt="Jeff Dangerfield"/></div>
        				    <div class="pull-right"><h5>Howdy, John!</h5><small>Logged in as <span>john</span></small></div>
                        </a>
        			</li>
        			<li class="userlinks">
        				<ul class="dropdown-menu">
        					...
        					<li class="divider"></li>
        					<li><a href="{{ url('admin/logout') }}" class="text-right">Sign Out</a></li>
        				</ul>
        			</li>
        		</ul>
        	</li>
