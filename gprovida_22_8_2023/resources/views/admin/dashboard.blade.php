        ...
        <div id="page-heading">
            <ol class="breadcrumb">
                <li class='active'><a href="#">Dashboard</a></li>
                 <li><a href="{{ url('admin/pins') }}"><i class="fa fa-tasks"></i>       <span>Pin Manager </span> </a> </li>
            </ol>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                <div class="tiles-heading">Total User Bonuses</div>
                                <div class="tiles-body-alt">
                                    <div class="text-center"><span class="text-top">₦</span>{{ number_format($revenue) }}</div>
                                    <small>Total pins sold</small>
                                </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                <div class="tiles-heading">Total User Bonuses</div>
                                <div class="tiles-body-alt">
                                    <div class="text-center"><span class="text-top">₦</span>{{ number_format($totalUserBonuses) }}</div>
                                    <small>User bonuses earned</small>
                                </div>
                                <div class="tiles-footer">more info</div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                <div class="tiles-heading">Released User Bonuses</div>
                                <div class="tiles-body-alt">
                                    <i class="fa fa-shopping-cart"></i>
                                    <div class="text-center"><span class="text-top">₦</span>{{ number_format($releasedUserBonuses) }}</div>
                                    <small>User bonuses released</small>
                                </div>
                         ...
                         <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center">{{ number_format($member_count) }}</div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        {{-- <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                <div class="tiles-heading">Total Referral</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-bar-chart-o"></i-->
                                    <div class="text-center"><span class="text-top">₦</span>{{ number_format($ref) }}</div>
                                    <small>Total Referral Bonus</small>
                                </div>
                                <div class="tiles-footer">more info</div>
                            </a>
                        </div> --}}
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                <div class="tiles-heading">Company Earnings</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-bar-chart-o"></i-->
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($companyEarnings) }}
                                    </div>
                                    {{-- <small>Total Referral Bonus</small> --}}
                                </div>
                                {{-- <div class="tiles-footer">more info</div> --}}
                        ...
                        {{-- <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                <div class="tiles-heading">Total Matrix Bonus</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-money"></i-->
                                    <div class="text-center"><span class="text-top">₦</span>{{ number_format($matrix) }}</div>
                                    <small>Total Matrix Bonus Bonus</small>
                                </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                <div class="tiles-heading">Actual Payout</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-money"></i-->
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($actualPayout) }}
                                    </div>
                                    {{-- <small>Total Matrix Bonus Bonus</small> --}}
                                </div>
                                {{-- <div class="tiles-footer">go to accounts</div> --}}
                        ...
                        {{-- <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                <div class="tiles-heading">Total Step Out Bonus</div>
                                <div class="tiles-body-alt">
                                    <i class="fa fa-shopping-cart"></i>
                                    <div class="text-center"><span class="text-top">₦</span>{{ number_format($step_out) }}</div>
                                    <small>Total Step Out Bonus </small>
                                </div>
                                <div class="tiles-footer">manage orders</div>
                            </a>
                        </div> --}}
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                <div class="tiles-heading">Payout Sum</div>
                                <div class="tiles-body-alt">
                                    {{-- <i class="fa fa-shopping-cart"></i> --}}
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($payoutSum) }}
                                    </div>
                                    {{-- <small>Total Step Out Bonus </small> --}}
                                </div>
                                {{-- <div class="tiles-footer">manage orders</div> --}}
                         ...
                         <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                <div class="tiles-heading">Product Company Sum</div>
                                <div class="tiles-body-alt">
                                    {{-- <i class="fa fa-group"></i> --}}
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($companySum) }}
                                     </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                <div class="tiles-heading">Total Purchases</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-bar-chart-o"></i-->
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($totalPurcahases) }}
                                    </div>
                                    {{-- <small>Total Referral Bonus</small> --}}
                                </div>
                                {{-- <div class="tiles-footer">more info</div> --}}
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                <div class="tiles-heading">Total Monthly Purchases</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-money"></i-->
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($monthlyPurcahases) }}
                                    </div>
                                    {{-- <small>Total Matrix Bonus Bonus</small> --}}
                                </div>
                                {{-- <div class="tiles-footer">go to accounts</div> --}}
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                <div class="tiles-heading">Total Product Earnings Paid Out</div>
                                <div class="tiles-body-alt">
                                    {{-- <i class="fa fa-shopping-cart"></i> --}}
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($totalProductPayout) }}
                                    </div>
                                    {{-- <small>Total Step Out Bonus </small> --}}
                                </div>
                                {{-- <div class="tiles-footer">manage orders</div> --}}
                         ...
                         <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                <div class="tiles-heading">Monthly Product Earnings To Pay</div>
                                <div class="tiles-body-alt">
                                    {{-- <i class="fa fa-group"></i> --}}
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($monthlyProductPayout) }}
                                    </div>
                                    {{-- <small>new users registered</small> --}}
                                </div>
                                {{-- <div class="tiles-footer"> manage members</div> --}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                <div class="tiles-heading">Leaders Incentive</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-bar-chart-o"></i-->
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($leadersIncentive) }}
                                    </div>
                                    {{-- <small>Total Referral Bonus</small> --}}
                                </div>
                                {{-- <div class="tiles-footer">more info</div> --}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                <div class="tiles-heading">Total Investments</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-bar-chart-o"></i-->
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($totalInvestments) }}
                                    </div>
                                    {{-- <small>Total Referral Bonus</small> --}}
                                </div>
                                {{-- <div class="tiles-footer">more info</div> --}}
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                <div class="tiles-heading">Paid Dividends</div>
                                <div class="tiles-body-alt">
                                    <!--i class="fa fa-money"></i-->
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($paidDividends) }}
                                    </div>
                                    {{-- <small>Total Matrix Bonus Bonus</small> --}}
                                </div>
                                {{-- <div class="tiles-footer">go to accounts</div> --}}
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                <div class="tiles-heading">Unpaid Dividends</div>
                                <div class="tiles-body-alt">
                                    {{-- <i class="fa fa-shopping-cart"></i> --}}
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($unpaidDividends) }}
                                    </div>
                                    {{-- <small>Total Step Out Bonus </small> --}}
                                </div>
                                {{-- <div class="tiles-footer">manage orders</div> --}}
                         ...
                         <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                <div class="tiles-heading">Actual Dividends To Pay</div>
                                <div class="tiles-body-alt">
                                    {{-- <i class="fa fa-group"></i> --}}
                                    <div class="text-center">
                                        <span class="text-top">₦</span>{{ number_format($actualDividend) }}
                                    </div>
                                    {{-- <small>new users registered</small> --}}
                                </div>
                                {{-- <div class="tiles-footer"> manage members</div> --}}
...
<!-- <script type='text/javascript' src='/adminTemplate/plugins/fullcalendar/fullcalendar.min.js'></script>
<script type='text/javascript' src='/adminTemplate/plugins/form-daterangepicker/daterangepicker.min.js'></script>
<script type='text/javascript' src='/adminTemplate/plugins/form-daterangepicker/moment.min.js'></script>
<script type='text/javascript' src='/adminTemplate/plugins/charts-flot/jquery.flot.min.js'></script>
<script type='text/javascript' src='/adminTemplate/plugins/charts-flot/jquery.flot.resize.min.js'></script>
<script type='text/javascript' src='/adminTemplate/plugins/charts-flot/jquery.flot.orderBars.min.js'></script>
<script type='text/javascript' src='/adminTemplate/plugins/pulsate/jQuery.pulsate.min.js'></script>
<script type='text/javascript' src='/adminTemplate/demo/demo-index.js'></script> -->
