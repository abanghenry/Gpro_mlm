                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" action="{{ url('admin/product')}}/{{$product->id}}"  method="POST" enctype='multipart/form-data' >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <textarea name="description" rows="6" class="form-control" required>{{$product->desc}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="type" id="type" class="form-control">
                                                @if($product->type == "1")
                                                    <option selected value="1">MLM & Retail</option>
                                                @elseif($product->type == "2")
                                                    <option selected value="2">MLM Only</option>
                                                @elseif($product->type == "3")
                                                    <option selected value="3">Retail Only</option>
                                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input name="pv" type="text" class="form-control" required value="{{$product->pv}}" >
                                            @if ($errors->has('pv'))
                                                <span class="text-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3 control-label">
                                            ...
                                            <input name="active" id="active" type="hidden" value="{{$product->active}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            @foreach($product->price as $productPrice)
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">{{ $productPrice->currency->code }}</label>
                                                    <div class="col-sm-8">
                                                        <input name="{{$productPrice->currency->code}}" type="text" required
                                                               class="form-control"  value="{{$productPrice->price }}">
                                                    </div>
                                                </div>
                                                <br/>
                                            @endforeach
