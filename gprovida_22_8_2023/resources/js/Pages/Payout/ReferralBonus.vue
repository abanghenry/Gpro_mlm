<template>
    <div class="page-wrapper">
        <Head :title="`Referral Bonus ${auth.user.username}`" />
        <div class="page-content">
            <!--breadcrumb-->
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Referral Bonus</div>
                <div class="ps-3">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Referral Bonus</h5>
                            </div>
                            <hr>
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table table-striped table-bordered">
                                    ...
                                    <tr v-for="(payment, index) in bonus" :key="payment.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                                        ...
                                        <td class="align-middle">{{payment.currency.prefix}}{{ payment.amount.toLocaleString() }}</td>
