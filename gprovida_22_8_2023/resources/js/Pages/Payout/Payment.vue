<template>
    <div class="page-wrapper">
        <Head :title="`Referral ${auth.user.username}`" />
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Payments History</h5>
                            </div>
                            <hr>
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <tr v-for="(payment, index) in payments" :key="payment.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                                        <td class="align-middle">{{ index+1 }}</td>
                                        <td class="align-middle">{{user.currency.prefix}}{{ payment.amount.toLocaleString() }}</td>
                                        <td class="align-middle">{{payment.bonus_type}}</td>
                                        <td class="align-middle">
                                            ...
                                            <div v-else-if="payment.status=='flushed'"
                                            ...
                                            <div v-else-if="payment.status=='cforward'"
