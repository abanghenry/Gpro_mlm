        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-9">
                    ...
                    <div v-if="(errors.length>0 || Object.keys($page.props.errors).length > 0) " class="alert alert-danger" role="alert">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <select class="form-select" v-model="form.paymentMethod" required>
                                    ...
                                    <option value="upgradepack">Upgrade Package</option>
                                </select>
                            </div>
                            <hr>
                            <div class="d-flex align-items-center gap-2">
...
export default {
    ...
    methods: {
        ...
        continueShopping(){
            this.$inertia.visit('/upgradepack', {
                method: 'get',
                data: {
                },
                preserveScroll: true,
        ...
        deleteFromCart(id){
            this.$inertia.visit('/upgradepack/delete', {
                method: 'delete',
                data: {
                    id: id,
                },
        ...
        store() {
            ...
            this.form.post(this.route('upgradepack.store'))
        },
