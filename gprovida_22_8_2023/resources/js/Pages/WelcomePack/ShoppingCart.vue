                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <select class="form-select" v-model="form.paymentMethod" required>
                                    ...
                                    <option value="welcomepack">Welcome Package</option>
                                </select>
                            </div>
                            <hr>
                            <div class="d-flex align-items-center gap-2">
...
export default {
    ...
    methods: {
        ...
        continueShopping(){
            this.$inertia.visit('/welcomepack', {
                method: 'get',
                data: {
                },
                preserveScroll: true,
        ...
        deleteFromCart(id){
            this.$inertia.visit('/welcomepack/delete', {
                method: 'delete',
                data: {
                    id: id,
                },
        ...
        store() {
            ...
            this.form.post(this.route('welcomepack.store'))
        },
