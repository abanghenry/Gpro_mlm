                ...
                <div class="col-12">
                    <div class="alert alert-primary border-0 bg-primary fade show py-2">
                          <div class="d-flex align-items-center">
                              ...
                              <div class="ms-3">
                                  <h6 class="mb-0 text-white">Welcome Pack</h6>
                                  <div class="text-white">Select Products for your welcome Pack, Maximum total Value:
                                      <b>{{user.currency.prefix}}{{user.package.price_user[0].price }}</b>
                                  </div>
                              </div>
                          </div>
                      </div>
...
export default {
    ...
    methods: {
        ...
        checkout(){
            this.$inertia.visit('/welcomepack/cart', {
                method: 'get',
                data: {
                },
            })
